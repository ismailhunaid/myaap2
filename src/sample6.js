...
class Sample6 extends Component {
    constructor(props){
        super(props)
this.state = {
    quranicFruits:[
        {
            id:1,
            name : 'dates',
            description:'Date trees typically reach about 21–23 metres (69–75 ft) in height,[7] growing singly or forming a clump with several stems from a single root system.',
            use:'beneficial',
        ...
        },
        {
            id:2,
            name:'banana',
            description:'A banana is an edible fruit – botanically a berry[1][2] – produced by several kinds of large herbaceous flowering plants in the genus Musa.',
            use:'beneficial',
    ...
    render(){
        return(
            <div>
                <h2> this is sample6 class based component 
                    contain internal state ane Sample7 and Sample8 will receive
                     state data using props 
                </h2>
<Sample7 quranicFruits={this.state.quranicFruits}/>
<Sample8 quranicFruits={this.state.quranicFruits} />
